...
<div class="row">
    <div class="col-lg-12">
         <h4>Sejarah Kemaskini</h4>
         <a href="{{ route('transaksi') }}"class="btn btn-secondary float-right" style="margin-right: 100px">Transaksi  Delete</a>
  ...
  <div class="card-deck">
    ...
    <table class="pure-table" id="dataTable" width="100%" cellspacing="0">
        ...
        @foreach($data as $permohonans=> $permohonan)
            ...
            <td>{!! nl2br(e($permohonan->status_nama)) !!}</td>
